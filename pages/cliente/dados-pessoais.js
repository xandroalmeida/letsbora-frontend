...
import { updateUserData } from '../../api/connect_api';
import FormUserData from '../../components/Checkout/FormCheckout/FormUserData';
...
function MeusPedidos(props) {
   ...
   async function updateInfoUser(userData) {
      setSending(true);
      const updated = await updateUserData(userData);
      ...
      <PageInterna1>
         <section className="minha-conta minha-conta-interna section section-gray">
            <div className="container">
               <MenuMinhaConta page="dados" />

               <h2 className="title text-center">Dados Pessoais</h2>
               ...
               <form onSubmit={handleSubmit(onSubmit)} className="template-form">
                  <FormUserData register={register} errors={errors} userDataCookie={loginData} enableNameEmail={true} />
