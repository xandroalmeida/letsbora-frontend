                     ...
                     <div className="container">
                        <div className="row">
                           ...
                           <div className="box-price">
                              <Link href={pathsMenu.wppIntercambio}>
                     ...
                     <div className="container">
                        <div className="row">
                           <div className="col-md-6">
                              ...
                              <p>{ReactHtmlParser(expInfoData.shortdesc)}</p>
                           </div>
                           <div className="col-md-6">
                              <div className="box-price box-fale-conosco">
                                 ...
                                 <Link href={pathsMenu.wppIntercambio}>
                                    <a target="blank">quero fazer intercâmbio</a>
                                 </Link>
                              </div>
                           </div>
                        </div>
                  ...
                  <div className="schedule-days">
                     <div className="container">
                        <ul>
                           {arrDaysSchedule && arrDaysSchedule.map((item, index) => {
                              ...
                              return <li key={`item-${expInfoData.idexperiencias}-${index}`}>
                                 ...
                                 {item.price && <Link href={pathsMenu.wppIntercambio}><a target="_blank" className="price-day">{item.price}</a></Link>}
                                 </div>}
                              </li>;
                           })}
                        </ul>
                        ...
                        <Link href={pathsMenu.contato}>
                           <a className="btn-vazado btn-see-more btn-personalize-intercambio-voluntario">personalize sua experiência de intercâmbio</a>
                        </Link>
                     </div>
                  </div>
